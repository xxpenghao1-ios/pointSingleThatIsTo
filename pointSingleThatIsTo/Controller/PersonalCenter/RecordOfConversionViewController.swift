...
extension RecordOfConversionViewController{
    func httpQueryIntegralMallExchangeRecord(currentPage:Int,isRefresh:Bool){
        var count=0
        request(.GET,URL+"queryIntegralMallExchangeRecord.xhtml", parameters:["memberId":IS_NIL_MEMBERID()!,"pageSize":10,"currentPage":currentPage]).responseJSON { response in
